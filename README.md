...
2. میتونید از ربات OPEN DOOR لینک ویدیو مورد نظرتون رو پیدا کنید و بعد ویدیو رو دانلود کنید

@opendoorbot 
توجه کنید فقط ذر پیام رسان بله هست 
3. در نوار سمت چپ، روی **🎯 YouTubeDownloader** کلیک کنید.
   > اگر این اسم رو نمی‌بینید، مطمئن بشید ریپازیتوری درست رو انتخاب کردید.
4. یک کادر آبی رنگ با عنوان **"This workflow has a workflow_dispatch event trigger"** ظاهر می‌شه.
5. سمت راست این کادر، روی دکمه **Run workflow** کلیک کنید.
6. یک پنجره باز می‌شه که باید اطلاعات زیر رو وارد کنید:
...
7. بعد از پر کردن اطلاعات، روی دکمه سبز رنگ **Run workflow** کلیک کنید.
